...
def scatter_plots_agrupados(df, col_categoria, col_num1, col_num2):
    ...
    sns.scatterplot(x=col_num1, y=col_num2, hue=col_categoria, data=df, palette="Reds")
